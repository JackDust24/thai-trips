...
export function TripForm({ trip }: { trip?: Trip | null }) {
  ...
  return (
    <form action={action} className='space-y-8'>
      ...
      <div className='space-y-2'>
        <Label htmlFor='numberOfPlaces'>Number of places allowed</Label>
        <Input
          type='number'
          id='numberOfPlaces'
          name='numberOfPlaces'
          ...
          required
          value={numberPlaces}
          onChange={(e) => setNumberPlaces(Number(e.target.value) || undefined)}
        />
      ...
      <div className='space-y-2'>
        ...
        <Input
          ...
          required
          value={priceInBaht}
          onChange={(e) => setPriceInBaht(Number(e.target.value) || undefined)}
        />
        <div className='text-muted-foreground'>
